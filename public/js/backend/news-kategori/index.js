$(function () {
    ...
    $('li#menu-news').find('.treeview-menu').find('.list-news-kategori a').addClass('sub-menu-active');

        // Formatter for edit/delete
    var formatActionField = function (row, cell, formatterParams) {
        var url = "news-kategori";
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Kategori", minWidth: 161, field: "kategori", headerFilter: "input", headerFilterPlaceholder: " "},
    ...
    $('#datalist').tabulator('setData', rootUrl + '/api/news-kategori/getNewsKategoriTabular');
