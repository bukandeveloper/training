$(function () {
    ...
    $('li#menu-news').find('.treeview-menu').find('.list-news a').addClass('sub-menu-active');
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Judul", minWidth: 161, field: "title", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Kontent", minWidth: 161, field: "content", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Publish Date", minWidth: 161, field: "publication_date", headerFilter: "input", headerFilterPlaceholder: " "},
    ...
    $('#datalist').tabulator('setData', rootUrl + '/api/news/getNewsTabular');
