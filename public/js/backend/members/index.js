$(function () {
    ...
    $('li#menu-members').find('.treeview-menu').find('.list-members a').addClass('sub-menu-active');
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Nama", minWidth: 161, field: "name", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Email", minWidth: 161, field: "email", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Alamat", minWidth: 161, field: "alamat", headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Telp", minWidth: 161, field: "telp", headerFilter: "input", headerFilterPlaceholder: " "},
    ...
    $('#datalist').tabulator('setData', rootUrl + '/api/members/getMembersTabular');
