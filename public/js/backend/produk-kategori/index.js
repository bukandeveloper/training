$(function () {
    ...
    $('li#menu-produk_kategori').addClass('menu-open active');
    $('li#menu-produk_kategori').find('.treeview-menu').css('display', 'block');
    $('li#menu-produk_kategori').find('.treeview-menu').find('.list-produk_kategori a').addClass('sub-menu-active');

        // Formatter for edit/delete
    var formatActionField = function (row, cell, formatterParams) {
        var url = "produk-kategori";
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Nama produk kategori", minWidth: 161, field: "nama", headerFilter: "input", headerFilterPlaceholder: " "},
    ...
    $('#datalist').tabulator('setData', rootUrl + '/api/produk-kategori/getProdukKategoriTabular');
