...
<!-- page title -->
@section('title', 'merek | ' . env('APP_NAME',''))
@section('content')
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-primary pull-right" href="{{ route('admin.merek.add') }}">Create New</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
@section('js-scripts')
    ...
    <script src="{{ asset('js/backend/merek/index.js') }}"></script>
@endsection
