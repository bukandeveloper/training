...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.produk-kategori') }}">Admin</a></li>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a class="btn btn-primary pull-right" href="{{ route('admin.produk-kategori') }}">back</a>
                </div>
                <div class="box-body">
                    @if ($errors->any())
                    ...
                    <div id="form-nama" class="form-group">
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2 col-header">
                            ...
                            <strong class="field-title">produk kategori</strong>
                        </div>
...
@section('js-scripts')
<script src="{{ asset('js/backend/produk-kategori/form.js') }}"></script>
@endsection