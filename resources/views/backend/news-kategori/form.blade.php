...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.news-kategori') }}">Admin</a></li>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a class="btn btn-primary pull-right" href="{{ route('admin.news-kategori') }}">back</a>
                </div>
                <div class="box-body">
                    @if ($errors->any())
                    ...
                    <div id="form-kategori" class="form-group">
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2 col-header">
                            <span class="label label-danger label-required">Required</span>
                            <strong class="field-title">Kategori</strong>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-content">
                            {{-- use this extra input to force chrome to turn autocomplete off --}}
                            {{ Form::text('kategori', $data->kategori, array('placeholder' => ' ', 'class' => 'form-control validate[required]', 'data-prompt-position' => 'bottomLeft:0,11')) }}
                        </div>
                    </div>
...
@section('js-scripts')
<script src="{{ asset('js/backend/news-kategori/form.js') }}"></script>
@endsection