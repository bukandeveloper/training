...
<!-- page title -->
@section('title', 'News Kategori | ' . env('APP_NAME',''))
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">News Kategori</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-primary pull-right" href="{{ route('admin.news-kategori.add') }}">Create New</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
@section('title', 'News Kategori List')
...
@section('js-scripts')
    ...
    <script src="{{ asset('js/backend/news-kategori/index.js') }}"></script>
@endsection
